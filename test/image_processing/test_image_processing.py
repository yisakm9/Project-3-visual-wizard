...
def test_successful_image_processing(monkeypatch):
    ...
    using a targeted mocking strategy.
    """
    ...
    # Moto will automatically mock these calls.
    ...
    # We will patch the specific global objects within the application module's namespace.
    with patch.object(image_processing, 'rekognition_client') as mock_rek_client, \
        ...
        # When the handler code calls dynamodb.Table(), make it return our moto-created table
